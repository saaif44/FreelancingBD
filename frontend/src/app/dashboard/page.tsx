...
const Dashboard = () => {
  ...
  const handleMessageButtonClick = async (freelancerProfileId) => {
    try {
        const messageData = {
            content: "Hi, I'm interested in your service",
            recipientId: freelancerProfileId,
            userId: selectUserId,
        };
                ...
                <div className="service-list">
                    {services.map((service) => (
                        <div className="service-card" key={service.id}>
                            ...
                            <p className="offer">Profile ID: {service.freelancer_profile_id}</p>
                            <button onClick={() => handleMessageButtonClick(service.freelancer_profile_id)} className="bid-button">
                                Message
                            </button>
                        </div>
                    ))}
                        ...
                        <div className="project-card" key={project.id}>
                            ...
                            {profileData?.role === 'FREELANCER' && (
                                <>
                                    ...
                                    <p>Posted on {new Date(project.created_at).toLocaleString()}</p>
                                    {userBiddedProjects.includes(project.id) ? (
                                        <p>You have already bid on this job. You will be notified soon by message.</p>
                                    ) : (
